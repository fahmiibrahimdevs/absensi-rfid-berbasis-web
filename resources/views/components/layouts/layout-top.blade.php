    ...
    <div id="app">
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <a href="{{ url('dashboard') }}" class="navbar-brand sidebar-gone-hide">ABSENSI RFID</a>
            ...
            <nav class="navbar navbar-secondary navbar-expand-lg">
                <div class="container">
                    <ul class="navbar-nav">
                        ...
                        <li
                            class="nav-item dropdown {{ request()->is('kelas') || request()->is('mahasiswa') || request()->is('jadwal') || request()->is('absensi') || request()->is('control-user') ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown {{ request()->is('mqtt') ? 'active' : '' }}">
                            <a href="#" data-toggle="dropdown" class="nav-link has-dropdown">
                                <i class="fas fa-server"></i><span>Internet Of Things</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="nav-item {{ request()->is('mqtt') ? 'active' : '' }}">
