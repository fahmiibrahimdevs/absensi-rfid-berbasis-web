                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr class='text-center'>
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td class='text-left'>{{ $row->jam_mulai }}</td>
                                    <td class='text-left'>{{ $row->jam_selesai }}</td>
                                    <td>
                ...
                <form>
                    <div class='modal-body'>
                        <div class='form-group'>
                            ...
                            <input type='time' wire:model='jam_mulai' id='jam_mulai' class='form-control'>
                            @error('jam_mulai') <span class='text-danger'>{{ $message }}</span> @enderror
                        </div>
                        <div class='form-group'>
                            <label for='jam_selesai'>Jam Selesai</label>
                            <input type='time' wire:model='jam_selesai' id='jam_selesai' class='form-control'>
